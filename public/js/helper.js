(function($) {
            ...
            if (typeof response.errors != "undefined") {
                ...
                if (opt.errorPosition == "field") {
                    for (var i = 0; i < keys.length; i++) {
                        ...
                        var allfilds = keys[i].split(".");
                        if(allfilds.length > 4){
                            var new_key = allfilds[0]+'['+allfilds[1]+']'+'['+allfilds[2]+']'+'['+allfilds[3]+']'+'['+allfilds[4]+']';
                            var ele = $("[name='" + new_key + "']");
                        }else if(allfilds.length > 2){
                             var new_key = allfilds[0]+'['+allfilds[1]+']'+'['+allfilds[2]+']';
                            var ele = $("[name='" + new_key + "']");
                            if (ele.length == 0) {
                                var ele = $("[name^='" + new_key + "']");
                            }
    ...
    $.showErrorsMul = function(all_object) {
        if(typeof all_object.errors !== undefined){
            var object = all_object.errors;
            var keys = Object.keys(object);
